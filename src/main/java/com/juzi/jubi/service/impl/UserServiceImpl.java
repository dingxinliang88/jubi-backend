...
import com.juzi.jubi.mapper.UserMapper;
...
import static com.juzi.jubi.constant.UserConstant.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "juzi";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        if (userPassword.length() < USER_ACCOUNT_MIN_LEN || checkPassword.length() < USER_ACCOUNT_MIN_LEN) {
